...
(
    ...
    constraint fk_recipe__creation_user_id foreign key (creation_user_id) references `user` (id),
    constraint fk_recipe__modification_user_id foreign key (modification_user_id) references `user` (id),
    constraint fk_recipe__recipe_book_id foreign key (recipe_book_id) references recipe_book (id)
)